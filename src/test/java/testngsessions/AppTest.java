...
WebDriver driver;
   ...
   @Test(description="open cart title test",priority=1)
	public void titleTest() {
		...
		System.out.println("pahe title:"+title);
		Assert.assertEquals(title, "Account Login","....open cart login page title is correct.....");
   }
	...
	@Test(description="open cart forgot password test",priority=3)
